...
def open_frame_directly(driver: webdriver.Chrome, wait: WebDriverWait) -> bool:
    """
...
def count_elements(driver: webdriver.Chrome) -> None:
    """Cuenta y lista RUT, proveedor, nombre oferta, total y estado."""
...
def _save_stream_to_file(
    ...
    base_path = os.path.join("Licitaciones", prov_dir, tipo_dir)
...
def main() -> None:
    ...
    try:
        ...
        if not open_frame_directly(driver, wait):
